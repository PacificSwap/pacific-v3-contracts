...
import '@pacificswap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IPacificV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function pacificV3SwapCallback(
        ...
        IPacificV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPacificV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
