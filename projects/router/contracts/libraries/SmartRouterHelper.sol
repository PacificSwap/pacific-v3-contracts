...
import '@pacificswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x387fb2ff8c03ad15bc04641d3bdd2ef9fba50785665b23c039fa16424240d77b;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xf1bdc5573af9d56801e0c0c36d18fedbf9793f23dc924c169e45be688e3e931f;
    ...
    /// @param deployer The Pacific V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IPacificV3Pool) {
        return IPacificV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid Pacific V3 Pool
    /// @param deployer The contract address of the Pacific V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IPacificV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (IPacificV3Pool pool)
    {
        pool = IPacificV3Pool(computeAddress(deployer, poolKey));
