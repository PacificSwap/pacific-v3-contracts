...
import './interfaces/IPacificV3PoolDeployer.sol';
import './interfaces/IPacificV3Factory.sol';
...
import '@pacificswap/v3-lm-pool/contracts/interfaces/IPacificV3LmPool.sol';

contract PacificV3Pool is IPacificV3Pool {
    ...
    // liquidity mining
    IPacificV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IPacificV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IPacificV3PoolDeployer(msg.sender).parameters();
    ...
    function mint(
        ...
        IPacificV3MintCallback(msg.sender).pacificV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IPacificV3SwapCallback(msg.sender).pacificV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IPacificV3FlashCallback(msg.sender).pacificV3FlashCallback(fee0, fee1, data);
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IPacificV3LmPool(_lmPool);
