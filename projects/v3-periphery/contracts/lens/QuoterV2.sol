...
contract QuoterV2 is IQuoterV2, IPacificV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPacificV3Pool) {
        return IPacificV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function pacificV3SwapCallback(
        ...
        IPacificV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPacificV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
